# There is much better way to do what this script trying to do: [this fork of innoextact](https://github.com/immi101/innoextract). I'm not going to maintain this script anymore.
